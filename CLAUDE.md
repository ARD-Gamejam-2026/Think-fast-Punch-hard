...
- `Assets/Scenes/SampleScene.unity` — registered in Build Settings. `Assets/Scenes/PlayerControllerTest.unity` is the fighter test rig, generated by `Tools > Think Fast > Build PlayerController Test Scene`.
